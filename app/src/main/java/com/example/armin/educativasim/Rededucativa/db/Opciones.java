...
public final class Opciones {
    ...
    public Opciones(int id, int pregunta_id, String opcion_a, String imagen_a_id, String opcion_b, String imagen_b_id, String opcion_c, String imagen_c_id, String opcion_d, String imagen_d_id) {
        this.id = id;
