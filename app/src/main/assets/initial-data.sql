...
INSERT INTO curso (id, name_course) VALUES (6, 'seis');
INSERT INTO curso (id, name_course) VALUES (7, 'siete');
INSERT INTO curso (id, name_course) VALUES (8, 'ocho');
INSERT INTO curso (id, name_course) VALUES (9, 'nuevo');
INSERT INTO curso (id, name_course) VALUES (10, 'diez gg wp gl hf');
...
INSERT INTO respuestas (id, pregunta_id, respuesta, imagen) VALUES (1, 1, 2, 0);
INSERT INTO respuestas (id, pregunta_id, respuesta, imagen) VALUES (2, 2, 1, 0);
...
INSERT INTO opciones (id, pregunta_id, opcion_a, imagen_a_id, opcion_b, imagen_b_id,opcion_c, imagen_c_id,opcion_d, imagen_d_id )
 VALUES (1, 1, '3', '','2.5', '', '2', '', '1.5','' );

 INSERT INTO opciones (id,pregunta_id, opcion_a, imagen_a_id, opcion_b, imagen_b_id,opcion_c, imagen_c_id,opcion_d, imagen_d_id )
 VALUES (2, 2, '60', '','55', '', '70', '', '75','' );

 INSERT INTO opciones (id,pregunta_id, opcion_a, imagen_a_id, opcion_b, imagen_b_id,opcion_c, imagen_c_id,opcion_d, imagen_d_id )
 VALUES (3, 3, '$12.65', '','$13.0', '', '$13.65', '', '$12.65','' );

  INSERT INTO opciones (id, pregunta_id, opcion_a, imagen_a_id, opcion_b, imagen_b_id,opcion_c, imagen_c_id,opcion_d, imagen_d_id )
 VALUES (4, 4, 'Generoso', '','Piadoso', '', 'bondadoso', '', 'Malo','' );

   INSERT INTO opciones (id, pregunta_id, opcion_a, imagen_a_id, opcion_b, imagen_b_id,opcion_c, imagen_c_id,opcion_d, imagen_d_id )
 VALUES (5, 5, 'beodo', '','curado', '', 'sobrio', '', 'rip','' );
